import chartConfig from "../../../storage/app/public/js/chartConfig";
        ...
        <>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-4 mt-4 mx-10 w-auto">
                ...
                <div className="shadow-xl rounded-lg p-4">
                    <div className="float-left">
                        <AccTab
                            title={"Silvana Rasio Henim"}
                            color={"gray"}
                            jumlah={"Admin / Kaprodi"}
                        />
                    </div>
                    <div className="float-right ">
                        <svg
            ...
            <div className="grid lg:grid-cols-2 gap-7 mt-5 lg:px-20 sm:grid-cols-1 lg:w-full sm:w-1/3 sm:px-10">
                <Card>
                    <CardHeader
                        floated={false}
                        shadow={false}
